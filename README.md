...
- `generate.py` 仍是生产编排入口；阿里百炼、硅基流动、MiniMax、DeepSeek、AiHubMix、n1n、ChatAnywhere、OpenRouter、Together AI、Novita AI、DeepInfra 已由 `src/platforms/` 中的生产抓取器负责，其余平台继续迁移。
...
- 继续迁移月之暗面、智谱 AI、火山引擎、Groq 等仍由旧生成器维护的平台。
